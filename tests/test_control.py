...
class TestControlMotor(unittest.TestCase):
    ...
    def _create_motor_object(self):
        return control.Motor(pi=self.pi, pin=4, start_signal=1000,
    ...
    def test_send_start_signal(self):
        ...
        self.assertTrue(motor.send_start_signal())
    ...
    def test_send_stop_signal(self):
        ...
        self.assertTrue(motor.send_stop_signal())

    def test_send_throttle_adjustment(self):
        """ Tests the throttle adjustment sending """
        motor = self._create_motor_object()
        self.assertTrue(motor.send_throttle_adjustment(100))
        # should fail because we already sent 100 and the maximum is 1890
        # 100 + 1800 = 1900 = FAIL
        self.assertFalse(motor.send_throttle_adjustment(1800))
